...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AMap.OnMapClickListener{
    ...
    private void initMapView() {
        ...
        LatLng beijing = new LatLng(40.10080756, 116.37034178);//高德地图：116.37034178；40.10080756// 百度地图：40.106683, 116.376924
        aMap.addMarker(new MarkerOptions().position(beijing).title("Marker in WenDuShuiCheng"));
